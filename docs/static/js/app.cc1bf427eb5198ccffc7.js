...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data() {
    return {
      title: 'Itens',
      itens: [{ name: 'Armaduras', target: 'armaduras', icon: 'ico-armor', disabled: false }, { name: 'Armas', target: 'armas', icon: 'ico-axes', disabled: false }, { name: 'Pacotes', target: 'pacotes', icon: 'ico-backpack', disabled: false }, { name: 'Diversos', target: 'diversos', icon: 'ico-axes', disabled: true }, { name: 'Ferramentas', target: 'pacotes', icon: 'ico-hammer', disabled: true }, { name: 'Transporte', target: 'pacotes', icon: 'ico-wheel', disabled: true }, { name: 'Comércio', target: 'pacotes', icon: 'ico-exchange', disabled: true }, { name: 'Despesas', target: 'pacotes', icon: 'ico-paper', disabled: true }, { name: 'Bugigangas', target: 'pacotes', icon: 'ico-windmill', disabled: true }]
    };
  }
});
